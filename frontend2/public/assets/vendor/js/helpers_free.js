  ...
  return (function () {
    ...
    var d = {
      ...
      setNavbarFixed: function () {
        this[
          (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : c("fixed")) ? "_addClass" : "_removeClass"
        ]("layout-navbar-fixed"),
          this.update();
      },
      ...
      setContentLayout: function () {
        ...
        setTimeout(function () {
          ...
          document.querySelector(".content-wrapper > .menu-horizontal > div") &&
            ((f = !0), (n = document.querySelector(".content-wrapper > .menu-horizontal > div"))),
            "compact" === t
              ? (u.some(function (e) {
            ...
            e.addEventListener("click", function (t) {
              ...
              "text" === o.getAttribute("type")
                ...
                : "password" === o.getAttribute("type") &&
                  (o.setAttribute("type", "text"), i.classList.replace("bx-hide", "bx-show"));
            });
          });
      },
