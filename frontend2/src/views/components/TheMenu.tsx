        ...
        <ul className="menu-inner py-1">
          ...
          <li className="menu-item">
            ...
            <ul className="menu-sub">
              ...
              <li className="menu-item">
                <a href="/account/notification" className="menu-link">
                  <div data-i18n="Notifications">Notifications</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/account/connection" className="menu-link">
          ...
          <li className="menu-item">
            ...
            <ul className="menu-sub">
              <li className="menu-item">
                <a href="/signin" className="menu-link" target="_blank" rel="noreferrer">
                  <div data-i18n="Basic">Sign in</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/register" className="menu-link" target="_blank" rel="noreferrer">
                  <div data-i18n="Basic">Register</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/forgot" className="menu-link" target="_blank" rel="noreferrer">
          ...
          <li className="menu-item">
            ...
            <ul className="menu-sub">
              <li className="menu-item">
                <a href="/404-not-found" className="menu-link">
                  <div data-i18n="Error">Error</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/under-maintenance" className="menu-link">
          ...
          <li className="menu-item">
            ...
            <ul className="menu-sub">
              <li className="menu-item">
                <a href="/form-element/basic" className="menu-link">
                  <div data-i18n="Basic Inputs">Basic Inputs</div>
                </a>
              </li>
              <li className="menu-item">
                <a href="/form-element/group" className="menu-link">
          ...
          <li className="menu-item">
            ...
            <ul className="menu-sub">
              <li className="menu-item">
                <a href="/form-layout" className="menu-link">
